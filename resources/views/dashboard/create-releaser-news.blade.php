...
@section('title','Dashboard | Create News Releaser')
@section('content')
...
<div class="row">
    <div class="col-md-12">
       {!! Breadcrumbs::render('addreleaser') !!}
    </div>    
</div>
@if ($errors->any())
...
@endif
<form action="{{ route('create-releaser') }}" method="post" enctype="multipart/form-data">
    {{ csrf_field() }}
    <div class="row">
        <div class="col-md-4" style="padding-left:3%; ">
            <label for="" class="">Releaser Name</label>  <br>
            <div class="form-group">
                <input type="text" name="releaser" required class="form-control" placeholder="Releaser Name">
            </div>
        </div>
        <div class="col-md-4">
