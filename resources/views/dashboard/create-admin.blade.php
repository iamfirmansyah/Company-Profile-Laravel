...
<div class="row">
    <div class="col-md-10">
        ...
        <input type="text" class="form-control" required name="name" style="border-radius: 1rem;" placeholder="Full Name"><br>
    </div>
</div>
<div class="row">
    <div class="col-md-10">
        <p class="text-muted">Email</p>
        <input type="email" class="form-control" required name="email" style="border-radius: 1rem;" placeholder="Email"><br>
    </div>
</div>
<div class="row">
    <div class="col-md-10">
        ...
        <div class="form-group mb-0">
                <div class="input-group">
                        <input type="password" required id="password" name="password" class="form-control" data-toggle="password" placeholder="Password">

                </div>
            </div>
        {{-- <div class="input-group-prepend">
                <span class="input-group-text"><i class="fas fa-eye " style="color:#7f7f7f"></i></span>
            </div>
         --}}
    </div>
</div>
    ...
    <div class="col-md-12">
        ...
        <div class="row">
            <div class="col-md-4 form-group">
                ...
                <img src="" class="d-none" id="preview-foto" alt="foto" width="100px">        
            </div>
        </div> 
    </div>
</div>
<div class="row">
        <div class="col-md-6 mx-auto">
            <input type="submit" class="btn btn-warning" style="border-radius:50px" value="SUBMIT ">
