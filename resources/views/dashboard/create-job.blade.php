...
@section('title','Dashboard | Create Job')
@section('content')
            ...
            <form action="{{ route('create-job') }}" method="POST">
                {{ csrf_field() }}
                    ...
                    <div class="form-group">
                            ...
                            <input type="text" name="job_title" required class="border form-control w-75">
                    </div>
                    <div class="form-group">
                        <label for="" class="text-muted">Description</label>
                        <textarea name="description" id="ckeditor" required cols="30" rows="10" class="form-control border ckeditor"></textarea>
                    </div>
                    <div class="form-group">
                        <label for="" class="text-muted">Requirement</label>
                        <textarea name="requirement" id="ckeditor" cols="30" rows="10" class="form-control border ckeditor"></textarea>
                    </div>
                    <div class="row">
