...
@section('title','Dashboard | Create News')
@section('content')
...
<div class="row">
    <div class="col-md-12" style="padding-left:3%; "><br>
        ...
        <div class="row">
            ...
            <textarea name="news_detail" required id="ckeditor" class="ckeditor" cols="30" rows="10"></textarea>
            </div>
        </div>
        <div class="row">
                <div class="col-md-10">
                    ...
                    <div class="form-group">
                        <input type="text" name="writer" required class="form-control" placeholder="Title">
                    </div>
                </div>
            </div>
        <br>
...
@endpush
<style>.p{ 
        font-size:14px;font-weight:400;font-family:Avenir-Heavy;color: #9B9B9B;
    }</style>