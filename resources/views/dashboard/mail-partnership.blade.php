    ...
    <div class="row" > 
        <div class="col-md-4 abu-abu" > 
            ...
            <div class="row" id="myList" role="tablist"> 
              <div class="col-md-6">  
                <a  class="nav-link"  href="{{ route('mail') }}" ><p class="pa active" style="font-weight: bold;"><strong> Careers ({{ $countC }}) </strong></p></a>                  
                </div>
                <div class="col-md-6">  
                <a class="nav-link text-white" id="list-profile-list" href="{{ route('mail-partner') }}" ><p style="border-bottom:2px solid #FDB813;"><strong>Partnership ({{ $countP }}) </strong></p></a>
                </div>
            </div>
          <!-- INI CAREER -->
...
<div class="tab-content" id="nav-tabContent">
  <div class="tab-pane  fade show active"  id="list-home" role="tabpanel" aria-labelledby="list-home-list">
    ...
    @foreach ($contacts as $contact)
      <div class="row"> 
        <div class="col-md-12 pa  btn" id="" style="padding:0px"> 
          ...
          <div class="row"> 
              ...
              <ul class="touch" id="touch">
                  @if ($contact->read_count == 0)
                    ...
                    <p class="pe text-yellow topicCount"  style=" margin-left:-50px">{{ ucfirst($contact->topic) }}</p>
                    @else
                    <p class="pa text-left" style="margin-left:-20px;">{{ ucfirst( $contact->name) }}</p>
                    <p class="pe" style="color: #9B9B9B;margin-left:-50px">{{ ucfirst($contact->topic) }}</p>
                    @endif
                </ul>
              </div>
