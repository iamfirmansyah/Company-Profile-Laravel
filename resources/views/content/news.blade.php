...
@section('content')
        <div class="container">
            <div class="owl-carousel owl-theme">
                    ...
                    <div class="item-f" style="background-image: url('{{asset('public/upload/images/highlight/'.$highlight->image)}}');" data-merge="6">
                        <div class="row" >
                            <div class="col-md-4">
                            </div>  
                        ...
                        <div class="item-s" style="background-image: url('{{asset('public/upload/images/highlight/'.$highlight->image)}}');" data-merge="5">
                            <div class="row">
        ...
        <div class="container" style="padding-bottom:10%;">
            ...
            <div class="col-md-12 pd-t-3">
                ...
                <div class="row" >
                    ...
                    <h4 style="font-weight:720">All News</h4>
                    {{-- CONTENT 1 --}}
                    <div class="row">                                
                        ...
                        <a href="{{ route('detail-artikel',[$artikel->year,$artikel->month,$artikel->id,$artikel->slug]) }}" class="text-white">
                                ...
                                <div class="image-artikel gmbr h20" style="background-image:url('{{asset('public/upload/images/news/'.$artikel->foto)}}');background-size:100%;background-repeat:no-repeat;width:100%">
                                </div>
                                <div class="col-md-12">
                                    <div class="row">
                                    ...
                                    <div class="col-md-4 bg-light"><img class="img-realeser" style="padding-top: 2px;" src="{{asset('public/upload/images/releasers/'.$artikel->releaser->foto)}}"  alt="" width="80%"></div>
                                    </div>
                                </div>
                                {{-- <div class="col-md-12"> --}}
                                ...
                                <div class="col-md-6" style=" font-family: OpenSans;  font-size: 14px;font-weight: 500; color: #9B9B9B;">{{ \Carbon\Carbon::parse($artikel->updated_at)->formatLocalized('%d %B %Y') }}</div>
                                        ...
                                        <a href="{{ route('detail-artikel',[$latest->year,$latest->month,$latest->id,$latest->slug]) }}">
                                                <div class="row p-2">
                                                    ...
                                                    <div class="col-md-12" style="margin-top">
                                                        ...
                                                        <p style="font-weight:bold;font-size:20px text-justify">{{str_limit($latest->title,50)}}</p>
                                        ...
                                        <div class="row">
                                            ...
                                            <a href="{{ route('category-artikel',[$namecat->year,$namecat->month,$namecat->id,$namecat->category]) }}">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-4">
                                                        {{-- @if ($namecat->category == 'Publication')  --}}
