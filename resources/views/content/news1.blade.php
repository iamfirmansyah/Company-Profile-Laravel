...
@section('content')
        ...
        <div class="container">
            <div class="owl-carousel owl-theme">
                    ...
                    <div class="item-f" style="background-image: url('{{asset('public/upload/images/highlight/'.$highlight->image)}}');" data-merge="4">
                        <div class="row">
                            <div class="col-md-6">
                            </div>
                ...
                <div class="row">
                    ...
                    <div class="row">                                
                        ...
                        <a href="{{ route('detail-artikel',[$artikel->year,$artikel->month,$artikel->id,$artikel->slug]) }}" class="text-white">
                                ...
                                <div class="image-artikel" style="background-image:url('{{asset('public/upload/images/news/'.$artikel->foto)}}');background-size:100%;background-repeat:no-repeat;height:280px;width:100%">
                                </div>
                                <div class="col-md-12">
                                    <div class="row">
                                        <div class="col-md-8 text-white" style="background:rgb(26,26,26);
                                        padding-top:13px;height:50px;text-align:center;">
                                            <p>{{ucfirst($artikel->category->category)}}</p>                                         
                                    </div>
                                ...
                                <h5 class="text-dark" style="padding:2%;font-weight:bold">{{str_limit( $artikel->title ,55)}}</h5>
                                <div class="col-md-12 bg-white">
                                <div class="row" style="padding-bottom:3%;">
                                <div class="col-md-6 text-secondary text-center">{{ \Carbon\Carbon::parse($artikel->updated_at)->formatLocalized('%d %B %Y') }}</div>
