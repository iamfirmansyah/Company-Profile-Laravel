    ...
    <div class="container" style="padding-bottom:10%;">
        ...
        <div class="col-md-12 pd-t-3">
            <div class="row">
                ...
                <h4 style="font-weight:720"><a href="{{ url('/news') }}"><i class="fas fa-arrow-left"></i></a> | Category : {{ ucfirst($categoryitem->category->category) }}</h4>
                    @endforeach
                
                <div class="row">
                    @foreach ($artikel as $item)
                    <div class="col-md-4 pd-t-3" style="margin-top: 20px;">
                    <a href="{{ route('detail-artikel',[$item->year,$item->month,$item->id,$item->slug]) }}" class="text-white">
                            
                            <div class="image-artikel gmbr" style="background-image:url('{{ asset('public/upload/images/news/'.$item->foto) }}');background-size:100%;background-repeat:no-repeat;height:280px;width:100%">
                            </div>
                            <div class="col-md-12">
                                <div class="row">
                                    <div class="col-md-8 text-white" style="background:rgb(26,26,26);
                                    padding-top:13px;height:50px;text-align:center;">
                                    <p style="font-size: 14px; ;font-weight: 600;float: left;">{{ ucfirst($item->category->category) }}</p> 
                                </div>
                                <div class="col-md-4 bg-light"><img class="" style="padding-top: 2px;" src="{{asset('public/upload/images/releasers/'.$item->releaser->foto)}}"  alt="" width="60px"></div>
                                </div>
                            </div>
                            {{-- <div class="col-md-12"> --}}
                            ...
                            <h5 class="text-dark"  style="margin-left: 3%;margin-right: 10%;padding:%;font-weight:800;  font-family: OpenSans;padding-bottom: 10%;height:100px">{{str_limit($item->title,52)}}</h5>
                            <div class="col-md-12 bg-white">
                            <div class="row" style="padding-bottom:3%;">
                            <div class="col-md-6 text-secondary text-center" style="margin-left: -20px; font-family: OpenSans;  font-size: 14px;font-weight: 500; color: #9B9B9B;">{{ \Carbon\Carbon::parse($item->updated_at)->formatLocalized('%d %B %Y') }}</div>
