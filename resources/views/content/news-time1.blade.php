        ...
        <div class="col-md-12 pd-t-3">
            <div class="row">
                ...
                <div class="col-md-9">
                    ...
                    <h4 style="font-weight:720">Archive : {{ \Carbon\Carbon::parse($ambilarchive->updated_at)->formatLocalized('%B') }} {{ \Carbon\Carbon::parse($ambilarchive->year)->formatLocalized('%Y') }}</h4>
                ...
                <div class="row">
                    ...
                    <a href="{{ route('detail-artikel',[$artikel->year,$artikel->month,$artikel->id,$artikel->slug]) }}" class="text-white">
                            ...
                            <div class="col-md-6 text-secondary text-center">{{ \Carbon\Carbon::parse($artikel->updated_at)->formatLocalized('%d %B %Y') }}</div>
                                <div class="col-md-6 text-dark fixed" style="">
